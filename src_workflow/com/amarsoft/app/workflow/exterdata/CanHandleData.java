 ...
 * @author 赵晓建
 */
public class CanHandleData implements IFlowData {

	/**
	 * 通过联机接口获取流程管理系统提供的可办理任务数据
	...
	public Map<String,Object> getData(Map<String,String> para,BusinessObjectManager bomanager) throws Exception{
		...
		BusinessObject rs = fm.queryMultiPcsAvlTask(taskContext, businessContext, Integer.parseInt(para.get("StartNum")), Integer.parseInt(para.get("PageNum")), true, para.get("UserID"), para.get("OrgID"));

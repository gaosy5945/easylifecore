 ...
 * @author 赵晓建
 */
public class AllData implements IFlowData {

	/**
	 * 通过联机接口获取流程管理系统提供的综合查询
	...
	public Map<String,Object> getData(Map<String,String> para,BusinessObjectManager bomanager) throws Exception{
		...
		BusinessObject rs = fm.queryMultiPcsAllTask(taskContext, businessContext, Integer.parseInt(para.get("StartNum")), Integer.parseInt(para.get("PageNum")), true, para.get("UserID"), para.get("OrgID"));

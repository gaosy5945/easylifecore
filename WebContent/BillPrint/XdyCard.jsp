...
if(contractserialNo == null)  contractserialNo = ""; //  2014121600011111  2014121600000001
//客戶號
...
//消贷易备用金账号
String rtnactno = "";
String transfer_direction = "";//划转方向

String transfer_amt = "";//划转金额

double oldSum = bcChange.getDouble("OLDBUSINESSSUM");
double newSum = bcChange.getDouble("NEWBUSINESSSUM");
if(newSum >= oldSum){
	transfer_direction = "划进";
	transfer_amt = DataConvert.toMoney(newSum-oldSum);
}else{
	transfer_direction = "划出";
	transfer_amt = DataConvert.toMoney(oldSum-newSum);
}

//打印时间
String TXDATE = StringFunction.getToday();
%> 

<head>
<title>消贷易额度划转开通通知书</title>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=636
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:51.9pt'>
  ...
  mso-font-kerning:0pt'>消贷易额度划转开通通知书</span></b><b><span lang=EN-US
 ...
 <tr style='mso-yfti-irow:2;height:74.5pt'>
  ...
  font-family:宋体;mso-font-kerning:0pt'>（申请人）的消贷易额度划转业务，已经按我行业务审批程序报经有权审批人审批同意，并通过放款监督审核，请你部按照本通知书要求，办理消贷易额度划转开通交易。<span
 ...
 <tr style='mso-yfti-irow:5;height:1.0cm;mso-height-rule:exactly'>
  ...
  style='mso-bidi-font-size:10.5pt;font-family:宋体;mso-font-kerning:0pt'>备用金<span

  class=GramE>帐号</span><span lang=EN-US><o:p></o:p></span></span></p>
  ...
  style='mso-bidi-font-size:10.5pt;font-family:宋体'><%=rtnactno %></span><span
 ...
 <tr style='mso-yfti-irow:8;height:1.0cm;mso-height-rule:exactly'>
  ...
  style='mso-bidi-font-size:10.5pt;font-family:宋体;mso-font-kerning:0pt'>额度划转方向<span
  ...
  style='mso-bidi-font-size:10.5pt;font-family:宋体'><%=transfer_direction %></span><span
  ...
  style='mso-bidi-font-size:10.5pt;font-family:宋体;mso-font-kerning:0pt'>划转金额<span
  ...
  style='mso-bidi-font-size:10.5pt;font-family:宋体'>&yen;<%=transfer_amt %></span><span

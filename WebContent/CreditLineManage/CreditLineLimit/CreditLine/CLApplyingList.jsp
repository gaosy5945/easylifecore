...
<%	
	...
	ASObjectModel doTemp = new ASObjectModel("CLApplyingList");
...
<script type="text/javascript">
	function writeOpinion(){
		...
		AsControl.PopView("/CreditLineManage/CreditLineLimit/CreditLine/CLApproveInfo.jsp","SerialNo="+serialNo+"&COSerialNo="+COSerialNo+"&CLSerialNo="+CLSerialNo,"");
		reloadSelf();
	}

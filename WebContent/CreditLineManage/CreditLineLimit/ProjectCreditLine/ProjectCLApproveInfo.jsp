...
<%
	...
	String sTempletNo = "ProjectCLApproveInfo1";//--模板号--
	...
	dwTemp.replaceColumn("APPROVECLINFO", "<iframe type='iframe' name=\"frame_list\" width=\"100%\" height=\"150\" frameborder=\"0\" src=\""+sWebRootPath+"/CreditLineManage/CreditLineLimit/ProjectCreditLine/ApproveProjectCLInfo.jsp?SerialNo="+CLSerialNo+"&CompClientID=" + sCompClientID + "\"></iframe>", CurPage.getObjectWindowOutput());
	String sButtons[][] = {

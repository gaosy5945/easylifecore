...
<link rel="stylesheet" href="<%=sWebRootPath%>/Frame/page/resources/css/strip.css">
...
$(document).ready(function(){
	...
	tabCompent.addDataItem('0',"示例1","AsControl.OpenView('/FrameCase/widget/dw/ExampleList.jsp','','TabContentFrame')",false,true);
	tabCompent.addDataItem('1',"示例2","AsControl.OpenView('/FrameCase/widget/dw/ExampleList02.jsp','','TabContentFrame')",false,true);
	tabCompent.addDataItem('2',"示例3","AsControl.OpenView('/FrameCase/widget/dw/ExampleList.jsp','','TabContentFrame')",false,false,true);
	//tabCompent.addDataItem('00X1',"Demo001","void(0)",true,false);
	tabCompent.init();

	var script = "OpenComp('ExampleList','/FrameCase/widget/dw/ExampleList.jsp','','TabContentFrame')";
	var number = 4;
	//--------------按钮事件绑定----------------------

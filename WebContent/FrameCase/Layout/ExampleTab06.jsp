...
$(document).ready(function(){
	...
	tabCompent.addDataItem('0010',"示例01","AsControl.OpenView('/FrameCase/widget/dw/ExampleList.jsp','','TabContentFrame')",true,true);
	tabCompent.addDataItem('0020',"示例02","AsControl.OpenView('/FrameCase/widget/dw/ExampleList.jsp','','TabContentFrame')",true,true);
	tabCompent.addDataItem('0030',"示例03","AsControl.OpenView('/FrameCase/widget/dw/ExampleList.jsp','','TabContentFrame')",true,true);
	//如果使用addDataItem,则必需调用init()函数
	tabCompent.initTab(); 

	var number = 4;
	var script = "AsControl.OpenView('/FrameCase/widget/dw/ExampleList.jsp','','TabContentFrame')";
	//这里绑定按钮事件
	//1.添加新Tab(不缓存)

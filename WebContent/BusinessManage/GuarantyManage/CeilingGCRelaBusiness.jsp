...
<%	
	String PG_TITLE = "占用最高额担保合同的贷款"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String serialNo = CurPage.getParameter("SerialNo");
	if(serialNo == null) serialNo = "";
	
	ASObjectModel doTemp = new ASObjectModel("CeilingGCRelaBusinessList");
	doTemp.appendJboWhere(" and O.ContractStatus in ('01','02','03') ");

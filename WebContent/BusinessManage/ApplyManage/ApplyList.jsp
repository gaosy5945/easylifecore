...
<tr height=1 valign=top bgcolor='#DCDCDC'>
    <td>
    	<table>
	    	<tr>
			<!--按照新增、详情、删除顺序排列按钮-->
	 		    <td><%=new Button("查询","选择查询条件","my_query()","","").getHtmlText()%></td>
                <td><%=new Button("新增","新增申请","my_add()","","").getHtmlText()%></td>
				<td><%=new Button("查看/修改","查看和修改申请","my_info()","","").getHtmlText()%></td>
				<td><%=new Button("删除","删除申请","my_del()","","").getHtmlText()%></td>
				<td><%=new Button("提交","提交申请","my_submit()","","").getHtmlText()%></td>
	            <td><%=new Button("收回","收回申请","my_callback()","","").getHtmlText()%></td>
				<td><%=new Button("打印业务送审表","打印业务送审表","my_print()","","").getHtmlText()%></td>
				<td><%=new Button("查看总行批复","查看总行批复","my_HQ()","","").getHtmlText()%></td>
                <td><%=new Button("查看分行批复","查看分行批复","my_BR()","","").getHtmlText()%></td>
                <td><%=new Button("合同登记","合同登记","my_addContract()","","").getHtmlText()%></td>
			</tr>
		</table>
    </td>
</tr>

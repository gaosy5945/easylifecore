...
<%
	...
	ASObjectWindow dwTemp = ObjectWindowHelper.createObjectWindow_Info("AfterLoanGuarantyAssetView1",inputParameter, CurPage, request);
...
<script type="text/javascript">
	function saveRecord(){
		...
		var returnValue = AsCredit.RunJavaMethodTrans("com.amarsoft.app.als.guaranty.model.GuarantyContractAction", "checkGuarantyPercent", "AssetType="+assetType+",GuarantyPercent="+guarantyPercent);

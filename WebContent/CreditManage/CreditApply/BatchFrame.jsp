...
<table><tr><%if(!isReadOnly){%>
	<td><form name="Attachment" style="margin-bottom:0px;" enctype="multipart/form-data" action="<%=sWebRootPath%>/CreditManage/CreditApply/BatchUpload.jsp?CompClientID=<%=CurComp.getClientID()%>&ObjectType=<%=objectType%>" method="post">

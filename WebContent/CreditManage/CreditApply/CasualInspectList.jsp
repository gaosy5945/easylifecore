...
<%
	String PG_TITLE = "录入抽检任务列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	...
	String sButtons[][] = {
		...
		{"true","All","Button","录入抽检","录入抽检","deal()","","","",""},	
...
<script type="text/javascript">
	...
	function deal(){
		...
		AsCredit.openFunction("DataEntryDeal04", "ObjectType=jbo.app.BUSINESS_APPLY&ObjectNo="+objectNo+"&Status=<%=status%>");
	}

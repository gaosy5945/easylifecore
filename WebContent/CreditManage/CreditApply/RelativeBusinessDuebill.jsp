...
<%
	...
	if(occurType.equals("015")||occurType.equals("020")){  //展期和借新还旧关联到之前的借据信息
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			{"true","","Button","详情","查看业务详情","viewAndEdit()","","","",""},
			{"true","","Button","变更关联合同","变更借据的关联合同","ChangeContract()","","","",""},
			{"true","","Button","查询借据余额","根据借据号查询借据余额","queryBalance()","","","",""}
		};
	%>
<%/*~END~*/%>

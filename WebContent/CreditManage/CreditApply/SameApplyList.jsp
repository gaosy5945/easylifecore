...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = 
		...
		{"true","","Button","详情","查看共同申请人情况","viewAndEdit()","","","",""},
		{"true","All","Button","删除","删除共同申请人情况","deleteRecord()","","","",""},
		{"true","","Button","共同申请人详细信息","查看共同申请人详细信息","viewCustomerInfo()","","","",""},
		};
	%>
<%/*~END~*/%>
	...
	function viewCustomerInfo()
	{
		...
		if(typeof(sSerialNo)=="undefined" || sSerialNo.length==0) {
			...
			if (sSerialNo.length == 1)
				...
				AsCredit.openFunction("CustomerDetail","CustomerID="+sSerialNo,"");

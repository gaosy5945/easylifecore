	...
	{			
		...
		if(sGuarantyType == '050' || sGuarantyType == '060' || sGuarantyType.substring(0,3) == '010')
		{
			...
			if(typeof(sLoanCardNo) != "undefined" && sLoanCardNo != "" )
			{
				...
				//机构号与贷款卡号的对应性校验。
				sReturn=RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.GetColValue","getColValue","colName=LoanCardNo,tableName="+ENT_INFO+",whereClause=String@CorpID@"+sCertID);

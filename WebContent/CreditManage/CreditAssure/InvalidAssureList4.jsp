...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {		
		...
		{"true","","Button","担保生效","将担保合同由失效变为生效","statusChange()","","","",""},
		};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function statusChange()
	{
		...
		{
			RunJavaMethodTrans("com.amarsoft.app.bizmethod.BusinessManage","updateGuarantyContractStatus","paras=SerialNo@@"+sSerialNo+"@~@ContractStatus@@020");
			reloadSelf();

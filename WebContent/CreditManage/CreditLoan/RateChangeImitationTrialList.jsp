...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "模拟利率变更结果"; // 浏览器窗口标题 <title> PG_TITLE </title>
	//从上个页面得到传入的参数
	...
	String SpclDate = CurPage.getParameter("SpclDate");
	String IntRateAdjType1 = CurPage.getParameter("IntRateAdjType1");
	String FloatPercent = CurPage.getParameter("FloatPercent");
	%>
<%/*~END~*/%>
...
<%	int sRepayMode = Integer.parseInt(RepayMode);
	...
	tmp1.put("FxdIntRate",IntRate);
	tmp1.put("FloatPercent",FloatPercent);
	tmp1.put("IntRateAdjType1",IntRateAdjType1);
	tmp.put("SpclDate",SpclDate);
	list2.add(tmp1);
	  ...
	  <td>
		<table  width=70%  style="border-collapse:collapse;" id="planList" align="center" border="2" cellpadding="0" cellspacing="0"  bordercolor="#000000">
		    <tr  bordercolor="#FFFFFF">
			  <th colspan=6 style="border-bottom:1px solid #000000;"><h1>模拟利率变更结果<h1></th>
		   </tr>
<%-- 		   <tr >
		   ...
		   <tr>
			  <th width=25% class="th_btn3" align="right">变更后贷款年利率:</th><td align="center" width=25%><%=StringEscapeUtils.escapeHtml(IntRate+"%")%></td>

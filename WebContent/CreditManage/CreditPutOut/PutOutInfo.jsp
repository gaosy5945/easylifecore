...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info00;Describe=注释区;]~*/%>
	...
	/*
		...
		History Log:  fXie 2005-03-13   增加校验关系、账号查询
		              ...
		              gftang 2013-11-30 DW改为OW,将分页功能拆出
	 */
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","All","Button","还款计划咨询","还款计划咨询","Simulation('"+sObjectType+"','"+sObjectNo+"')",""}
		};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function ValidityCheck(){
			...
			&& typeof(sBCPutOutDate) != "undefined" && sBCPutOutDate != "")
			{
				if(sPutOutDate < sBCPutOutDate)
				{
					...
					}else
					{
						...
						//加工装配业务进口保函、其他非融资性保函、个人教育贷款、个人工程机械贷款、个人经营贷款、
						//个人住房装修贷款、国家助学贷款、个人消费汽车贷款、个人住房公积金贷款、
						//个人商用汽车贷款、买入返售业务、有价证券发行担保、贷款担保、
						//个人小额担保贷款、个人质押贷款、贷款承诺函、个人经营循环贷款、
						//转贷买方信贷、个人小额信用贷款、个人委托贷款、个人投资置业贷款
						//转贷外国政府贷款、个人二手商业用房贷款、进口信用证、
						//个人一手商业用房贷款、备用信用证、提货担保、转贷国际金融组织贷款、
						//国家外汇储备转贷款、个人二手住房贷款、发行债券转贷款、其他转贷款、
						//个人一手住房贷款、贷款意向书、银行信贷证明、
						//出口保理、进口保理
						{
			...
			&& typeof(sBCMaturity) != "undefined" && sBCMaturity != "")
			{
				if(sMaturity > sBCMaturity)
				{
					...
					}else
					{
						...
						//付款保函、其他融资性保函、投标保函、履约保函、预付款保函、承包工程保函
						//质量维修保函、海事保函、补偿贸易保函、诉讼保函、留置金保函、
						//加工装配业务进口保函、其他非融资性保函、个人工程机械贷款、个人教育贷款
						//个人住房装修贷款、国家助学贷款、个人消费汽车贷款、个人住房公积金贷款、
						//个人商用汽车贷款、买入返售业务、有价证券发行担保、贷款担保、
						//个人小额担保贷款、个人质押贷款、贷款承诺函、个人经营循环贷款、
						//转贷买方信贷、个人小额信用贷款、个人委托贷款、个人投资置业贷款
		...
		if(sDisplayTemplet=="PutOutInfo1"||sDisplayTemplet=="PutOutInfo0053"||sDisplayTemplet=="PutOutInfo0010"){
			   ...
			   //出账利率浮动值>合同利率浮动值
			   if(sRateFloat>=100){
				   alert("利率浮动值必须在[-100,100]范围内！");
					return false;
			   }
				if(sRateFloat<dRateFloat){
					alert("出账利率浮动值必须大于等于合同利率浮动值");
					return false;
				}    
		}
	    //出帐金额

...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","","Button","担保合同信息","担保合同管理","AssureManage()","","","",""},			
			{"false","","Button","借还款记录","借还款记录管理","WasteBookManage()","","","",""},		
			{"true","","Button","工作笔记","贷后工作笔记","WorkRecord()","","","",""},
			{"true","","Button","移交保全","将不良资产移交保全部管理","ShiftRMDepart()","","","",""},
			{"true","","Button","加入重点链接","加入重点链接","AddUserDefine()","","","",""},
			{"true","","Button","催收函管理","催收函管理","my_DunManage()","","","",""},
			{"true","","Button","合同终结","终结类型补登","my_Finish()","","","",""},
			{"true","","Button","还款方式补登","还款方式补登","my_ReturnWay()","","","",""},

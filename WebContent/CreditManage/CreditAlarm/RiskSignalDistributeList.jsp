...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {				
			...
			{"true","","Button","指定认定人","为所选中的预警信号指定认定人","commitRecord()","","","",""}		
		};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function commitRecord()
	{
		...
		if(typeof(sCognUserInfo)!="undefined" && sCognUserInfo.length!=0)
		{
			...
			//新增分发记录com.amarsoft.app.lending.bizlets.DistributeRiskSignal
			sReturnInfo = RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.DistributeRiskSignal","distributeRiskSignal","objectNo="+sSerialNo+",checkUser="+sCognUserID);

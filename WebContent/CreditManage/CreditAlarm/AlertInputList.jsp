...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
		{"false","","Button","新增","新增一条记录","newRecord()","","","",""},
		{"false","","Button","详情","查看/修改详情","viewAndEdit()","","","",""},
		{"false","","Button","删除","删除所选中的记录","deleteRecord()","","","",""},
		{"false","","Button","原始情况","查看相关的业务对象","openWithObjectViewer()","","","",""},
		{"false","","Button","分发","分发所选中的记录","distribute()","","","",""},
		{"false","","Button","跟踪","跟踪处理情况","follow()","","","",""},
		{"false","","Button","完成处理","完成处理","finish()","","","",""},
		};

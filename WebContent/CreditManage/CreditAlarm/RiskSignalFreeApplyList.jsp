...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
			{(sSignalStatus.equals("10")?"true":"false"),"","Button","新增","新增一个待解除的预警信号","newRecord()","","","",""},
			{((!sSignalStatus.equals("10") && !sSignalStatus.equals("20"))?"true":"false"),"","Button","查看意见","查看/修改认定意见详情","viewOpinion()","","","",""},
			{"true","","Button","预警解除详情","查看/修改详情","viewAndEdit()","","","",""},
			{(sSignalStatus.equals("10")?"true":"false"),"","Button","提交","提交所选中的记录","commitRecord()","","","",""}		
		};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	{		
		...
		sReturn = RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.AddRiskSignalFreeInfo","addRiskSignalFreeInfo","objectNo="+sSerialNo+",userID="+"<%=CurUser.getUserID()%>");
	...
	function commitRecord()
	{
	    ...
	    {
			//取消归档操作
			sReturn = RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.UpdateColValue ","updateColValue","colName=String@SignalStatus@15,tableName=RISK_SIGNAL,whereClause=String@SerialNo@"+sSerialNo);
			if(typeof(sReturn) == "undefined" || sReturn.length == 0) {					

<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sButtons[][] = {	
			{(sFinishType.equals("N")?"true":"false"),"","Button","预警检查详情","填写该笔预警信息的预警检查报告","newReport()","","","",""},		
			{(sFinishType.equals("Y")?"true":"false"),"","Button","查看预警检查报告","查看/修改预警检查报告详情","viewReport()","","","",""},
			{"true","","Button","预警详情","查看/修改详情","viewAndEdit()","","","",""},
			{(sFinishType.equals("N")?"true":"false"),"","Button","完成检查","提交所选中的记录","commitRecord()","","","",""}		
	};
...
<script type="text/javascript">
	...
	function commitRecord(){
		...
		//提交操作
		sReturn = RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.UpdateColValue","updateColValue","colName=String@FinishDate@<%=StringFunction.getToday()%>,tableName=RISK_SIGNAL,whereClause=String@SerialNo@"+sSerialNo);

...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增报告","newRecord()","","","",""},
		{"true","","Button","详情","查看报告详情","viewAndEdit()","","","",""},
		{"true","","Button","删除","删除该报告","deleteRecord()","","","",""},
		{"true","","Button","客户基本信息","查看客户基本信息","viewCustomer()","","","",""},
		{"true","","Button","业务清单","查看业务清单","viewBusiness()","","","",""},
		{"false","","Button","完成","完成报告","finished()","","","",""},
		{"false","","Button","撤回","重新填写报告","ReEdit()","","","",""}
		};

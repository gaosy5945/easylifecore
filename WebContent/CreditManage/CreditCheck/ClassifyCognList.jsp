...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {		
		{"true","","Button","模型分类详情","查看模型分类详情","Model()","","","",""},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function Finished(){
		...
		if(confirm(getBusinessMessage('659'))){ //您确定已经分类完成吗？
			...
			sReturn = RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.UpdateColValue ","updateColValue","colName=String@"+sFieldName+"@"+sFinishDate+",tableName=CLASSIFY_RECORD,whereClause=String@SerialNo@"+sSerialNo);

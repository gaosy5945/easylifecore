...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			{(sClassifyType.equals("010")?"true":"false"),"","Button","新增分类","新增分类(单笔)","newSingleRecord()","","","",""},
			{"false","","Button","新增分类(批量)","新增分类(批量)","newBatchRecord()","","","",""},
			{(sClassifyType.equals("010")?"true":"false"),"","Button","模型分类","模型分类","Model()","","","",""},
			{(sClassifyType.equals("020")?"true":"false"),"","Button","模型分类详情","查看模型分类详情","Model()","","","",""},
			{(sClassifyType.equals("010")?"true":"false"),"","Button","分类认定","分类认定","viewAndEdit()","","","",""},		
			{(sClassifyType.equals("020")?"true":"false"),"","Button","分类认定详情","查看分类认定详情","viewAndEdit()","","","",""},				
			{(sClassifyType.equals("010")?"true":"false"),"","Button","分类完成","分类完成","Finished()","","","",""},	
			{(sClassifyType.equals("010")?"true":"false"),"","Button","删除","删除分类","deleteRecord()","","","",""}	,
			{(sObjectType.equals("BusinessContract")?"true":"false"),"","Button","合同详情","查看合同详情","ContractInfo()","","","",""},
			{(sObjectType.equals("BusinessDueBill")?"true":"false"),"","Button","借据详情","查看借据详情","DueBillInfo()","","","",""}	
		};		
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function Finished()
	{
		...
		{	
			...
			sReturn = RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.UpdateColValue","updateColValue","colName=String@FinishDate@"+sFinishDate+",tableName=CLASSIFY_RECORD,whereClause=String@SerialNo@"+sSerialNo);

...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		//新增资产风险分类信息
	    sReturn = AsControl.RunJsp("/CreditManage/CreditCheck/ConsoleClassifyAction.jsp","AccountMonth="+sAccountMonth+"&ResultType="+sResultType+"&ObjectType="+sObjectType+"&ObjectNo="+sObjectNo+"&ModelNo=Classify1");

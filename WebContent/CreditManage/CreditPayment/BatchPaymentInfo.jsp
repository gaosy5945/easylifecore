...
<%
	...
	String sTempletNo = "BatchPaymentInfo";//--模板号--
	
	BusinessObject inputParameter = BusinessObject.createBusinessObject();
	inputParameter.setAttributeValue("ObjectType", objectType);
	inputParameter.setAttributeValue("ObjectNo", objectNo);
	inputParameter.setAttributeValue("SerialNo", transaction.getString("RelativeObjectNo"));
...
<script type="text/javascript">
	...
	function batchImport(){
		...
		var parameter = "clazz=jbo.import.excel.CREDIT_PAYMENT&UserID=<%=CurUser.getUserID()%>&OrgID=<%=CurOrg.getOrgID()%>&ParentTransSerialNo=<%=objectNo%>&BatchSerialNo=<%=transaction.getString("RelativeObjectNo")%>";
	...
	function reload()
	{
		AsControl.OpenComp("/CreditManage/CreditPayment/BatchPaymentList.jsp","ParentTransSerialNo=<%=objectNo%>","sys_sub_page_frame_BAT")
	}
</script>

...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		...
		{"true","","Button","额度使用查询","额度使用查询","QueryUseInfo()","","","",""}
		};
	...
	function deleteRecord()
	{
		...
		if(confirm(getHtmlMessage('2')))//您真的想删除该信息吗？
		{
			...
			if (typeof(sReturn)=="undefined" || sReturn.length==0){
	            RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.DeleteBusiness.DeleteLineRelative","deleteLineRelative","lineID="+sSerialNo);

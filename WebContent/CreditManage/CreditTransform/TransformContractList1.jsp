...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{sRelationStatus.equals("020")?"true":"false","All","Button","新增","新增担保合同","newRecord()","","","",""},
		{sRelationStatus.equals("020")?"true":"false","All","Button","引入","引入最高额担保合同","importGuaranty()","","","",""},
		{sRelationStatus.equals("030")?"true":"false","All","Button","引入","拟解除担保合同","importRecord()","","","",""},
		{"true","","Button","详情","查看担保信息详情","viewAndEdit()","","","",""},
		{sRelationStatus.equals("020")?"true":"false","All","Button","删除","删除担保信息","deleteRecord()","","","",""},
		{sRelationStatus.equals("030")?"true":"false","All","Button","删除","删除解除担保","cancelRecord()","","","",""},

...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{(sRelationStatus.equals("020")?"true":"false"),"","Button","新增","新增质物信息","newRecord()","","","",""},
		{(sRelationStatus.equals("020")?"true":"false"),"","Button","引入","引入已经登记的质物信息","importGuaranty()","","","",""},
		{"true","","Button","详情","查看质物信息详情","viewAndEdit()","","","",""},
		{(sRelationStatus.equals("020")?"true":"false"),"","Button","删除","删除质物信息","deleteRecord()","","","",""}
	};
	%>
<%/*~END~*/%>

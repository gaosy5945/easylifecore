...
<form name="Attachment" style="margin-bottom:0px;" enctype="multipart/form-data" action="<%=sWebRootPath%>/CreditManage/Collection/CollRegExcelImpAction.jsp?CompClientID=<%=CurComp.getClientID()%>" method="post">
	 <div id='div_tips'></div>
	...
	<li>导入数据第一行模板版本，第二行模板填写注意事项，第三行标题，第四行开始为导入数据
	</ol>

...
<%
	...
	BusinessObject bailInfo = bom.loadBusinessObject(BUSINESSOBJECT_CONSTANTS.bail_info, sDocumentSerialNo);//保证金信息
%>
...
<table width="627" height="330">
  ...
  <tr>
    <td width="266"> 业务内容：&nbsp;<%=NameManager.getBusinessTypeName(loan.getString("BusinessType"), Sqlca)%></td>

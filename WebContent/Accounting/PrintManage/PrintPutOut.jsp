...
<%
	...
	BusinessObject rateSegment = bom.loadBusinessObject(BUSINESSOBJECT_CONSTANTS.loan_rate_segment, rateSerialno);
...
<table width="621" height="330">
  ...
  <tr>
    <td width="263"> 业务内容：&nbsp;<%=NameManager.getBusinessTypeName(loan.getString("BusinessType"), Sqlca) %></td>

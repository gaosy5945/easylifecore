...
<%
	...
	BusinessObject paymentLog = bom.loadBusinessObject(BUSINESSOBJECT_CONSTANTS.PaymentLog, sSerialNo);
	BusinessObject transPayment = bom.loadBusinessObject(BUSINESSOBJECT_CONSTANTS.back_bill, sTransSerialNo);
	BusinessObject paymentSchedule = bom.loadBusinessObject(BUSINESSOBJECT_CONSTANTS.payment_schedule, sPSSerialNo);
...
<table width="621" height="330">
  ...
  <tr>
    <td width="258"> 业务内容：&nbsp;<%=NameManager.getBusinessTypeName(loan.getString("BusinessType"), Sqlca)%></td>

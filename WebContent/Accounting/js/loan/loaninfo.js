			...
			if("PutOutApply"==objectType){
				...
				if(!(typeof(termMonth) == "undefined" || termMonth==null||termMonth.length == 0||termMonth==0)){
					var termMonthFlag ="020";
					 ...
					 maturity=RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.CalcMaturity","calcMaturity","loanTermFlag="+termMonthFlag+",loanTerm="+termMonth+",putOutDate="+putOutDate);
 					 var termDay=getItemValue(0,getRow(),"TermDay");
					if(!(typeof(termDay) == "undefined" || termDay==null||termDay.length == 0||termDay==0)){
						var termDayFlag ="010";
						maturity=RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.CalcMaturity","calcMaturity","loanTermFlag="+termDayFlag+",loanTerm="+termDay+",putOutDate="+maturity);
					}
				}		
			}

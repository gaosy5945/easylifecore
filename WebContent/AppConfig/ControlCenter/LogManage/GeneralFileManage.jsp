...
<% 
	String dataHome = CurPage.getParameter("FilePath");
	if(StringX.isEmpty(dataHome)) dataHome="/plbs/app/log/web_log";
...
<script type="text/javascript">
	...
	function queryFile(){
		...
		AsControl.OpenView("/AppConfig/ControlCenter/LogManage/GeneralFileManage.jsp", "FilePath="+filePath, "_self", "");
	}
...
<div style="position:absolute;width:100%; height:100%; z-index:1; overflow: auto" align="center">
	...
	<tr><td>请输入路径：<input id="filePath" value=""><input type="button" value="查询" onclick="queryFile()">当前路径:<%=dataHome %>
	</td></tr></table>
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>

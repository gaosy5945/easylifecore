...
MetaNode.prototype.startEdit = function () {
	...
	if(editStatus == "000"){
		...
		returnValue = PopComp("WFCfgUserSelect","/AppConfig/FlowManage/FlowModelInfo.jsp","FlowNo="+flowNo+"&PhaseNo="+phaseNo+"&Editable="+editStatus+"&IsInuse="+isInuse,"dialogWidth:600px;dialogHeight:480px;center:yes;help:no;scroll:no;status:no;resizable:yes;");

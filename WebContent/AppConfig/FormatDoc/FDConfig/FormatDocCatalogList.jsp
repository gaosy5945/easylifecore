<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/Frame/resources/include/include_begin_list.jspf"%><%
	...
	String sButtons[][] = {
		...
		{"true","","Button","自定义读取D001","自定义读取","customRead()","","","",""},
	};
...
<script type="text/javascript">
 	...
 	function customRead(){
 		AsControl.PopView("/AppConfig/FormatDoc/FDConfig/FormatDocCustomRead.jsp",'',"dialogWidth=600px;dialogHeight=500px;resizable=yes;maximize:yes;help:no;status:no;");
	...
	//---------------------------格式化报告的功能测试---------------------------
 	function newFormatDoc(){
		var sDocID = "D001";
		var sObjectNo = "2011062400000017"; //测试业务

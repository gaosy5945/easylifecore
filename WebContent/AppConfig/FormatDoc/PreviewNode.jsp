...
*/
 ...
 <div id=div1 style="display:none" > 
	...
	<tr>
	  <td width="10px"></td> 	
	  <td width="90px"><%=new Button("复制到粘贴板","AutoCopy","autoCopy()","","").getHtmlText()%></td>
	  <td width="78px"><%=new Button("导出到Word","ExportToWord","exportToWord()","","").getHtmlText()%></td>
	  <td width="65px"><%=new Button("关闭","Close","top.close();","","").getHtmlText()%></td>
	</tr>
	</table>
</div>
<br/><br/>
...
<%
out.println("<table align=\"center\" style=\"width:660px;table-layout:fixed;background:url("+fconfig.getHttpRootPath() + oData.getWatermark() +")\"><tr><td style=\"white-space:nowrap;overflow:hidden;\">" + oData.getHtml(sMethod,"GBK") + "</td></tr></table>");//获得HTML
%>
</div>
</body>

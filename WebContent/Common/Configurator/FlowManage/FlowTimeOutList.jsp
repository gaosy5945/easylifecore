...
<%	
	ASObjectModel doTemp = ObjectWindowHelper.createObjectModel("FlowTimeOutList",BusinessObject.createBusinessObject(),CurPage);
...
<script type="text/javascript">
	...
	function SelectPhaseNo(){
		AsCredit.setMultipleTreeValue("SelectPhaseNo", "", "", "","myiframe0",getRow(0),"PhaseNo","PhaseName");
	}
	function SelectBusinessType(){
		AsCredit.setMultipleTreeValue("SelectAllBusinessType", "", "", "","myiframe0",getRow(0),"BUSINESSTYPE","BUSINESSTYPEName");
	}
</script>

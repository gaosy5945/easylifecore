...
<%	
	//ASObjectModel doTemp = new ASObjectModel("FlowOrgVetoList");
	//ASObjectWindow dwTemp = new ASObjectWindow(CurPage,doTemp,request);
	ASObjectModel doTemp = ObjectWindowHelper.createObjectModel("FlowOrgVetoList",BusinessObject.createBusinessObject(),CurPage);
...
<script type="text/javascript">
	function add(){
		...
		setItemValue(0,getRow(),"VETOFLAG","1");

...
<table><tr><%if(!isReadOnly){%>
	<td><form name="Attachment" style="margin-bottom:0px;" enctype="multipart/form-data" action="<%=sWebRootPath%>/Common/Configurator/FlowManage/UploadData.jsp?CompClientID=<%=CurComp.getClientID()%>&EdocNo=<%=edocNo%>" method="post">

...
<%	
	ASObjectModel doTemp = ObjectWindowHelper.createObjectModel("OrgEasyAccessList",BusinessObject.createBusinessObject(),CurPage);
...
<script type="text/javascript">
	...
	function SelectOrg(){
		...
		AsCredit.setMultipleTreeValue("SelectEasyAccessOrg",  "SerialNo,"+serialNo, ",", "","myiframe0",getRow(0),"OrgID","OrgName");
	}
</script>

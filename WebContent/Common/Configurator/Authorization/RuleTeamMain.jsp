<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		--页面说明:示例对象信息查看页面--
	 */
	String PG_TITLE = "授权团队"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;授权团队&nbsp;&nbsp;"; //默认的内容区标题
...
<script type="text/javascript"> 
	...
	function TreeViewOnClick(){
		var sCurItemID = getCurTVItem().value;
		var sCurItemname = getCurTVItem().name;
		if(sCurItemname!=""){
			openChildComp("/Common/Configurator/Authorization/RuleTeamList.jsp","OrgID="+sCurItemID,"");
		}else{
			return;
		}

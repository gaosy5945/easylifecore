...
function view(){
	var ProjectSerialNo = getItemValue(0,getRow(0),"OBJECTNO");
	var CustomerID = getItemValue(0,getRow(0),"CUSTOMERID");
	var RightType = "ReadOnly";
	AsCredit.openFunction("ProjectCLViewMainInfo","ProjectSerialNo="+ProjectSerialNo+"&CustomerID="+CustomerID+"&RightType="+RightType);
}
</script>

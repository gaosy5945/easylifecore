...
function view(){
	...
	var serialNo = getItemValue(0,getRow(0),'SERIALNO');
 	var duebillSerialNo = getItemValue(0,getRow(0),'BDSERIALNO');
	...
	var returnValue = AsCredit.openFunction("CollTaskInfo","SerialNo="+serialNo+"&DuebillSerialNo="+duebillSerialNo+"&DoFlag=check&ContractSerialNo="+contractSerialNo);
	if(returnValue == "true"){
		reloadSelf();
		edit();
	}else reloadSelf();

...
/* 	ASObjectModel doTemp = new ASObjectModel("ApplyProjectList");
	...
	ASObjectModel doTemp = ObjectWindowHelper.createObjectModel("ApplyProjectListReport",inputParameter,CurPage);
	...
	String sButtons[][] = {
			...
			{"false","All","Button","引入","引入","addProject()","","","","btn_icon_add",""},
			{"false","","Button","详情","详情","edit()","","","","btn_icon_detail",""},
			{"false","All","Button","删除","删除","deleteproject()","","","","btn_icon_delete",""},
		};
%>

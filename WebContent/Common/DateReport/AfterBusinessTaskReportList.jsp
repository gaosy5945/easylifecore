...
function view(){
	 ...
	 if(creditInspectType == "01" || creditInspectType == "02"){
		AsCredit.openFunction("FundDirectionInfo","RightType=ReadOnly&CreditInspectType="+creditInspectType+"&PutOutDate="+putOutDate+"&SerialNo="+serialNo+"&DuebillSerialNo="+duebillSerialNo+"&ContractSerialNo="+contractSerialNo);
		reloadSelf();
		return;
	 }else if(creditInspectType == "03"){
		 AsCredit.openFunction("RunDirectionInfo","RightType=ReadOnly&CreditInspectType="+creditInspectType+"&CustomerID="+customerID+"&SerialNo="+serialNo+"&DuebillSerialNo="+duebillSerialNo+"&ContractSerialNo="+contractSerialNo);
		 reloadSelf();
		 return;
	 }else {
		 AsCredit.openFunction("ConsumeDirectionInfo","RightType=ReadOnly&CreditInspectType="+creditInspectType+"&CustomerID="+customerID+"&SerialNo="+serialNo+"&DuebillSerialNo="+duebillSerialNo+"&ContractSerialNo="+contractSerialNo);
		 reloadSelf();
		 return;
	 }
}

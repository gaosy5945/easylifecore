...
<%
	...
	tempNo="LoanHistoryBillCheckReport";
	String sColString="";
	String sql=" SELECT CR.OBJECTNO FROM CONTRACT_RELATIVE CR "+
			" where CR.OBJECTTYPE='jbo.app.BUSINESS_CONTRACT_HS' AND CR.CONTRACTSERIALNO ='"+ObjectNo+"' "+
			" and CR.RELATIVETYPE in('07') UNION SELECT CR.CONTRACTSERIALNO  "+
			" FROM CONTRACT_RELATIVE CR  "+
			" where CR.OBJECTTYPE='jbo.app.BUSINESS_CONTRACT_HS' AND CR.OBJECTNO ='"+ObjectNo+"' "+
...
function view(){
	 ...
	 var ApplySerialNo = getItemValue(0,getRow(0),'ApplySerialNo');
	 AsCredit.openFunction("LoanHistoryCheckInfoTab","SerialNo="+serialNo+"&ApplySerialNo="+ApplySerialNo,"");
}

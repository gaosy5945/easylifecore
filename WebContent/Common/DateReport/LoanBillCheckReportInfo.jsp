...
function view(){
	 var serialNo = getItemValue(0,getRow(0),'SERIALNO');
		...
		AsControl.PopComp("/Common/DateReport/LoanBillCheckReportInfo.jsp","SerialNo="+serialNo, "resizable=yes;dialogWidth=650px;dialogHeight=1200px;center:yes;status:no;statusbar:no");  
}
</script>

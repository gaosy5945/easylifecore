...
function initDay(){
	var dialogStyle="dialogWidth=400px;dialogHeight=350px;center:yes;resizable:yes;scrollbars:no;status:no;help:no";
	var sReturn = popComp("ChooseInitDate","/SystemManage/SynthesisManage/ChooseInitDate.jsp","Area=<%=sArea%>",dialogStyle);
		if(sReturn=="true"){
			alert("初始化成功。");
			self.reloadSelf();
		}else{

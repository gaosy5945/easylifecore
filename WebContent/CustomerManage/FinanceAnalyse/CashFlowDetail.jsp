...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","现金流预测","进行现金流预测","my_compute()","","","",""},
		{"true","","Button","转出至电子表格","转出至电子表格","my_export()","","","",""},
		{"true","","Button","返回","返回现金流预测列表","my_close()","","","",""},
		};
	%>
<%/*~END~*/%>
...
<script type="text/javascript">
   ...
   /*~[Describe=导出到电子表格;InputParam=后续事件;OutPutParam=无;]~*/
	...
	{
		sReturn = RunJavaMethodTrans("com.amarsoft.app.als.finance.analyse.CashFlowCompute","compute","CustomerID=<%=sCustomerID%>,BaseYear=<%=sBaseYear%>,ReportScope=<%=sReportScope%>,YearCount=<%=sYearCount%>");
		if(sReturn="succeed"){
			return sReturn;

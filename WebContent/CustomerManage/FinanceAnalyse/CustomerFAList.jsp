...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function structureInfo(){
		...
		sReturnValue = PopPage("/CustomerManage/FinanceAnalyse/AnalyseTerm.jsp?CustomerID=<%=sCustomerID%>","","resizable=yes;dialogWidth=600px;dialogHeight=500px;center:yes;status:no;statusbar:no");
	...
	function trendInfo(){
	    //返回值：报表的期数、报表的年月、报表范围
		sReturnValue = PopPage("/CustomerManage/FinanceAnalyse/AnalyseTerm_Trend.jsp?CustomerID=<%=sCustomerID%>","","resizable=yes;dialogWidth=600px;dialogHeight=500px;center:yes;status:no;statusbar:no");
		if(typeof(sReturnValue)=="undefined" || sReturnValue=="_none_" || sReturnValue == null) return;

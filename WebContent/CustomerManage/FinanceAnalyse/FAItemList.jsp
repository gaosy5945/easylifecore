...
<td>
	<table><tr>
		<td>
			<%=new Button("结构分析","结构分析","javascript:structureInfo()","","").getHtmlText()%>
		</td>
		<td>
			<%=new Button("指标分析","指标分析","javascript:itemInfo()","","").getHtmlText()%>
		</td>
		<td>
			<%=new Button("趋势分析","趋势分析","javascript:trendInfo()","","").getHtmlText()%>
		</td>
		<td>
			<%=new Button("行业数据库分析","行业数据库分析","javascript:indAnaInfo()","","").getHtmlText()%>
		</td>
		<td>
			<%=new Button("现金流预测","现金流预测","javascript:cashFlowInfo()","","").getHtmlText()%>
		</td>
	</tr></table>
</td>	
</tr>

...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {		
		{"true","","Button","客户详情","查看集团成员客户信息详情","viewCustomer()","","","",""},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	*/
        ...
        sReturn = RunJavaMethodTrans("com.amarsoft.app.als.customer.action.CustomerRoleAction","checkBelongAttributes","CustomerID="+sCustomerID+",UserID=<%=CurUser.getUserID()%>");

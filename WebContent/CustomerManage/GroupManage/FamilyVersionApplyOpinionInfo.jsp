...
<script type="text/javascript">
	...
	function checkApplyAction(){
		...
		var sReturn = RunJavaMethodTrans("com.amarsoft.app.als.customer.group.action.FamilyVersionApplyOpinionAction","familyVersionApplyOpinionAction","groupID="+sGroupID+",versionSeq="+sVersionSeq+",userID="+sUserID);

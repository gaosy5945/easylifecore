<%@page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sButtons[][] = {	
		{"true","","Button","保存","保存申请认定书","save()","","","",""},
		{"true","","Button","申请认定书预览","申请认定书预览","nextStep()","","","",""},		
	};
%>
<HTML>
<HEAD>
					...
					<tr>
						<td text-align ="left" width="2%" height="100%"> 
							<table width="100%" height="100%"> 
								<tr><td height="50%">
										<img border='0' src='<%=CurConfig.getImagePath()%>/chooser_orange/arrowRight_disabled.gif'
								...
								<tr><td height="50%">
											<img border='0' src='<%=CurConfig.getImagePath()%>/chooser_orange/arrowLeft_disabled.gif'
...
<script type="text/javascript">
	...
	function save(){
		...
		var boolvalue =RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.SaveGroupRela","saveGroupRela","serialNo=<%=sSerialNo%>,relaMaStr="+parentCustomerID.join("@")+",relaChildStr="+chileCustomerID.join("@"));
		if(boolvalue == "1" ){			
			alert("保存成功");
			bSaveFlag = true;
		}else if(boolvalue == "2"){

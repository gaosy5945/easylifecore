...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "客户名单类型管理"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sTempletNo = "SpecialCustCodeList"; 
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		   ...
		   {"true","","Button","详情","查看代码详情","viewAndEdit()","","","",""},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function my_add()
	{ 	 
	  	OpenPage("/CustomerManage/SpecialCustomerManage/SpecialCustomerCodeInfo.jsp","_self","");
		reloadSelf();
	}	                                                                                                                                                                                                                                                                                                                                                 
	...
	{
		itemNo = getItemValue(0,getRow(),"ITEMNO");

...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sTempletNo = "IndCustomerRelativeInfo";//模型编号
	...
	{
		doTemp.setUnit("RELATIVECUSTOMERNAME"," <input class=\"inputdate\" type=button value=\"...\" onclick=parent.selectCustomer()><font color=red>(可输可选)</font>"); 
	 ...
	 */
	//生成HTMLDataWindow
	Vector vTemp = dwTemp.genHTMLDataWindow(sCustomerID+","+sRelativeCustomerID+","+sRelationShip);//传入参数,逗号分割

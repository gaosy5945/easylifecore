...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","","Button","新增经营企业","新增经营企业","saveRecordTemp()","","","",""}
		};
	%> 
<%/*~END~*/%>
		...
		if(sCustomerType == '01'){ //公司客户
			...
			if(sECGroupFlag == '1'){ //是否征信标准集团客户（1：是；2：否）
				...
				if(typeof(sSuperLoanCardNo) != "undefined" && sSuperLoanCardNo != "" ){
					...
					sReturn=RunJavaMethodTrans("com.amarsoft.app.lending.bizlets.CheckLoanCardNo","checkLoanCardNo","customerName="+sSuperCorpName+",loanCardNo="+sSuperLoanCardNo);
					if(typeof(sReturn) != "undefined" && sReturn != "" && sReturn == "Many"){

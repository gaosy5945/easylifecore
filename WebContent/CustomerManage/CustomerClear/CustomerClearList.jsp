...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	...
	if(CurUser.hasRole(RolesConst.ROLE_MANAGE)){
		
		doTemp.WhereClause+=" and CB.UserID='"+CurUser.getUserID()+"' and CB.BELONGATTRIBUTE='"+CustomerConst.HAVENO_1+"'";
	}
...
<%@page import="com.amarsoft.app.als.sys.tools.RolesConst"%>

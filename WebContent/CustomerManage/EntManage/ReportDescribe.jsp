...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function checkFSMonth(){
		...
		sReportDate = getItemValue(0,getRow(),"ReportDate");
		sReturn=RunJavaMethodTrans("com.amarsoft.app.bizmethod.CustomerManage","checkFSRecord","paras=customerID@@"sCustomerID+"@~@recordNo@@"+sRecordNo+"@~@reportDate@@"+sReportDate);

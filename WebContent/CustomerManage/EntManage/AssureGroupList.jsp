...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增联保小组成员信息","newRecord()","","","",""},
		{"true","","Button","详情","查看联保小组成员信息详情","viewAndEdit()","","","",""},
		{"true","","Button","删除","删除联保小组成员信息","deleteRecord()","","","",""},
		{"true","","Button","客户详情","查看联保小组成员客户信息详情","viewCustomer()","","","",""},
		};
	%>
<%/*~END~*/%>

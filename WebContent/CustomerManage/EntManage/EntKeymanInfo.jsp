...
/* 	if(!(sRelativeID == null || sRelativeID.equals("")))
	...
	String sButtons[][] = {
		...
		{(sEditRight.equals("02")?"true":"false"),"All","Button","保存并新增","保存所有修改并新增","saveAndNew(newRecord)","","","",""},
		{"true","","Button","高管信息详情","查看高管信息详情","viewKeymanInfo()","","","",""},
	...
	function saveRecord(sPostEvents){
		if(bIsInsert){
			...
			if(relationship == "0100"){
				...
				var hasKeyMan =  RunJavaMethodTrans("com.amarsoft.app.als.customer.common.action.GetKeyMan","hasKeyMan",sPara);
				if (hasKeyMan == "true"){
					alert("已经存在法人代表(高管)");
					return;
				}

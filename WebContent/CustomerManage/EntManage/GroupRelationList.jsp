...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","集团客户搜索","集团客户搜索","my_relativesearch()","","","",""},
		{"true","","Button","新增成员","手工新增集团成员客户","my_RelativeAdd()","","","",""},
		{"true","","Button","查看成员详情","查看成员详情","my_customerinfo()","","","",""},
		{"true","","Button","集团客户认定申请书","集团客户认定申请书","my_relativefile()","","","",""},
		};
	%>
<%/*~END~*/%>

...
%>          
	          <script type="text/javascript">
	              ...
	              //parent.reloadSelf();  
	              // modify by liuzq 20150310 修改路径：/AppConfig/Document/AttachmentFiles.jsp  为 /AppConfig/Document/AttachmentFrame.jsp
	              <%-- AsControl.OpenPage("/AppConfig/Document/AttachmentFiles.jsp", "DocNo=<%=sDocNo%>", "_self"); --%>
	              AsControl.OpenPage("/ActiveCreditManage/CustomerBaseManage/CustomerBaseAttachmentFrame.jsp", "DocNo=<%=sDocNo%>", "_self");
	          </script>
<%
     		}
       	}

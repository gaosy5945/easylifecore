...
<%	
	...
	String sButtons[][] = {
			...
			{String.valueOf(!sBDType.equals("030")),"All","Button","新增","新增","add()","","","","btn_icon_add",""},
			{"true","","Button","详情","详情","edit()","","","","btn_icon_detail",""},
			{String.valueOf(!sBDType.equals("030")),"","Button","删除","删除","if(confirm('确实要删除吗?'))as_delete(0)","","","","btn_icon_delete",""},
		};
%>

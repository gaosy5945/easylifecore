<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sButtons[][] = {
			{sFinishType.equals("")?"true":"false","","Button","新增","新增客户持有债券信息","newRecord()","","","",""},
			{"true","","Button","详情","查看客户持有债券详细信息","viewAndEdit()","","","",""},
			{sFinishType.equals("")?"true":"false","","Button","删除","删除客户持有债券信息","deleteRecord()","","","",""},
			};
		%>
	<%/*~END~*/%>

...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
			{(sFinishType.equals("")?"true":"false"),"","Button","新增分类","新增分类","newRecord()","","","",""},
			...
			{(sFinishType.equals("")?"true":"false"),"","Button","分类完成","分类完成","Finished()","","","",""},	
			{(sFinishType.equals("")?"true":"false"),"","Button","删除","删除分类","deleteRecord()","","","",""}	,

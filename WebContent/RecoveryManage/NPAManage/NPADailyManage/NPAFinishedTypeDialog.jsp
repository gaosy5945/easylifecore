...
<form name="buff">
  ...
  <table align="center" width="160" border='0' cellspacing='0' bordercolor='#999999' bordercolordark='#FFFFFF'>
    <tr>
     <td nowrap align="right" class="black9pt" bgcolor="#F0F1DE"><%=new Button("确认","确认","newFinishedType()","","").getHtmlText()%></td>
     <td nowrap bgcolor="#F0F1DE" ><%=new Button("取消","取消","self.returnValue='';self.close()","","").getHtmlText()%></td>
    </tr>
  </table>    

...
<%
	...
	String sButtons[][] = {
		...
		{"true","","Button","变更管理人","不良合同保全部管理人更改","my_ChangeUser()","","","",""},
		{"false","","Button","变更移交类型","合同管理性质转换","my_ShiftManage()","","","",""},
		{"true","","Button","查看管理人变更记录","不良合同保全部管理人更改记录","my_ChangeUserRec()","","","",""},
		{"false","","Button","查看移交类型变更记录","查看移交类型变更记录","my_ChangeType()","","","",""}
		};

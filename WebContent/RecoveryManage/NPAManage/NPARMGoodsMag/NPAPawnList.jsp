<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sButtons[][] = {			
			{"true","","Button","详情","查看抵质押物信息详情","viewAndEdit()","","","",""},
			{"true","","Button","价值变更","抵质押物价值变更","valueChange()","","","",""},
			{"true","","Button","其他信息变更","抵质押物其他信息变更","otherChange()","","","",""},
			{"true","","Button","资产监管信息","资产监管信息","assetWard()","","","",""}
		};

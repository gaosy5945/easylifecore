...
<%
	//依次为：
		...
		String sButtons[][] = {
					{"false","","Button","新增重组方案","新增重组方案","NewRecord()","","","",""},
					{"false","","Button","删除重组方案","删除已批准未执行的重组方案","DeleteRecord()","","","",""},
					{"false","","Button","拟重组原贷款","查看拟重组原贷款","viewAndEdit()","","","",""},
					{"false","","Button","重组前原贷款","查看拟重组原贷款","viewAndEdit()","","","",""},
					{"false","","Button","重组方案详情","查看重组方案详情","viewReform()","","","",""},
					{"false","","Button","重组后新贷款","查看重组贷款信息","ReformCredit()","","","",""},
					{"false","","Button","重组方案执行台帐","重组方案执行台帐","ReformBook()","","","",""},
					{"false","","Button","归档","归档","archive()","","","",""},
					{"false","","Button","取消归档","取消归档","cancelarch()","","","",""}
				};

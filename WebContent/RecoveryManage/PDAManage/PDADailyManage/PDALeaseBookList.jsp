<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "PDADisposalBookList";
	...
	String sButtons[][] = {
			{sAssetStatus.equals("04")?"false":"true","","Button","新增","新增","newRecord()","","","",""},
			{"true","","Button","详情","详细信息","viewAndEdit()","","","",""},
			{sAssetStatus.equals("04")?"false":"true","","Button","删除","删除","deleteRecord()","","","",""},
			{"true","","Button","处置情况汇总","处置情况汇总","my_Statistics()","","","",""}
		};
	%> 
<%/*~END~*/%>

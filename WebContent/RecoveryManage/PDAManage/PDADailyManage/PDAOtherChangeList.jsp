<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	//生成HTMLDataWindow
	Vector vTemp = dwTemp.genHTMLDataWindow(sAssetSerialNo);
	for(int i=0;i<vTemp.size();i++) out.print((String)vTemp.get(i));
	String sButtons[][] = {
		{sAssetStatus.equals("03")?"false":"true","All","Button","新增","新增变动记录","newRecord()","","","",""},
		{"true","","Button","详情","变动记录详情","viewAndEdit()","","","",""},
		{sAssetStatus.equals("03")?"false":"true","All","Button","删除","删除变动记录","deleteRecord()","","","",""}
		};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		OpenPage("/RecoveryManage/PDAManage/PDADailyManage/PDAOtherChangeInfo.jsp?AssetSerialNo="+sAssetSerialNo,"right","");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/RecoveryManage/PDAManage/PDADailyManage/PDAOtherChangeInfo.jsp?SerialNo="+sSerialNo+"&AssetSerialNo="+sAssetSerialNo+"&AssetStatus="+sAssetStatus,"right","");
		}
	}	
	</script>
<%/*~END~*/%>

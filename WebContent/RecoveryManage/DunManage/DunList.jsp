...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
			{"true","","Button","新增","新增催收函","newRecord()","","","",""},
			{"true","","Button","详情","查看/修改详情","viewAndEdit()","","","",""},
			{"true","","Button","删除","删除当前催收函","deleteRecord()","","","",""},
			{"true","","Button","打印催收函","打印催收函","PrintDunLetter()","","","",""},
			{(flag.equals("page")?"true":"false"),"","Button","返回","返回到授信台帐","goBack()","","","",""}
	};	
	%>	
<%/*~END~*/%>

...
<%
	...
	sSql = " select BC.PRESERVEUSERID as RecoveryUserID,getUserName(BC.PRESERVEUSERID) as RecoveryUserName "+
	...
	sSql = 	" select AmbientName,PropertyOrg "+
			...
			" and AssetType=:ObjectType1 "+
			" and Serialno = (select  max(Serialno) from ASSET_INFO where ObjectNo = :ObjectNo2 and  AssetType=:ObjectType2)";

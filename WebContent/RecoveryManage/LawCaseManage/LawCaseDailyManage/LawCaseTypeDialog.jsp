...
<table align="center" width="250" border='0' cellspacing='0' bordercolor='#999999' bordercolordark='#FFFFFF'>
	<tr>
		<td nowrap align="right" class="black9pt" bgcolor="#F0F1DE" ><%=new Button("确认","","newLawCaseType()","","").getHtmlText()%></td>
		<td nowrap bgcolor="#F0F1DE" ><%=new Button("取消","","self.returnValue='_CANCLE_';self.close()","","").getHtmlText()%></td>
	</tr>
</table>    

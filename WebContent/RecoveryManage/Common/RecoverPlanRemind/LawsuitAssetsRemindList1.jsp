...
<%
	...
	String sTempletNo = "LawsuitAssetsRemindList";//模型编号LawsuitAssetsList
	...
	String sButtons[][] = {
			...
			{"false","","Button","详情","查看/修改详情","viewAndEdit()","","","","btn_icon_detail",""},
			{"false","All","Button","删除","删除所选中的记录","deleteRecord()","","","","btn_icon_delete",""},
			{"false","","Button","使用ObjectViewer打开","使用ObjectViewer打开","openWithObjectViewer()","","","","",""},
		};
%>

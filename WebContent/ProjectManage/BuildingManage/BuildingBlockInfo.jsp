...
<%	
	...
	ASObjectModel doTemp = new ASObjectModel("BuildingBlockInfo");
...
<script type="text/javascript">
	function goBack(){
		AsControl.OpenView("/ProjectManage/BuildingManage/BuildingBlockList.jsp","BuildingSerialNo="+"<%=buildingSerialNo%>","_self");
	}
	function initRow(){

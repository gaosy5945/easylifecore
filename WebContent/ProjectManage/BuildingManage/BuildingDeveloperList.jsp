...
<%	
	...
	ASObjectModel doTemp = new ASObjectModel("BuildingDeveloperList");
...
<script type="text/javascript">
	function add(){
		...
		AsControl.OpenView("/ProjectManage/BuildingManage/BuildingDeveloperInfo.jsp","SerialNo=&BuildingSerialNo="+buildingSerialNo,"_self","");
		reloadSelf();
	}
	function edit(){
		...
		AsControl.OpenView("/ProjectManage/BuildingManage/BuildingDeveloperInfo.jsp","SerialNo="+serialNo+"&BuildingSerialNo="+buildingSerialNo,"_self","");
		reloadSelf();
	}
</script>

...
<%
	...
	if(sFlag.equals("0")){
		...
		%>javascript:parent.OpenComp("RiskSignalCheckList","/CreditManage/CreditAlarm/RiskSignalCheckList.jsp","FinishType=N","right","") 
                      	<tr>
                      	   <td align="left" ><%=sTipsFlag%><a href="javascript:OpenComp('RiskSignalCheckList','/CreditManage/CreditAlarm/RiskSignalCheckList.jsp','FinishType=N','_top','')"><%=rsTips.getString(1)%>&nbsp;</a></td>
                     	<br></tr>
		<%
		}
		rsTips.getStatement().close();

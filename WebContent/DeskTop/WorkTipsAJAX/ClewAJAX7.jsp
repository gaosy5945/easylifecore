...
<%
	...
	String sEndDate = StringFunction.getRelativeDate(StringFunction.getToday(),7);
	...
	if(sFlag.equals("0")){
		...
		%>
                      	<tr>
                      	   <td align="left" ><%=sTipsFlag%><a href="javascript:OpenComp('MatureLoanAlertList','/CreditManage/CreditAlarm/MatureLoanAlertList.jsp','Days=7','_top','')"><%=rsTips.getString(1)%>&nbsp;</a></td>

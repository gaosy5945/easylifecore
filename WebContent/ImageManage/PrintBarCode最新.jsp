		...
		<P>
			<div class="pitureDiv">
				<div align="center"  hspace="20"  border="0" align="middle">
					<table>
					   <tr><td><font size="4">资料名称:<%=TypeNames[i]%></font></td><th align="center" rowspan="4"><img src="<%=sWebRootPath%>/servlet/BarCodeServlet?TypeNo=<%=TypeNos[i]%>&TypeName=<%=TypeNames[i]%>" ></th></tr>

...
<script type="text/javascript"> 
	...
	function TreeViewOnClick() {
		var sCurItemID = getCurTVItem().id;
		var sCurItemName = getCurTVItem().name;
		//AsControl.OpenView("/ImageManage/ImageTypeList.jsp","StartWithId="+sCurItemID, "right");
		OpenComp("ImageTypeManageFrame","/ImageManage/ImageTypeManageFrame.jsp", "StartWithId="+sCurItemID, "right" );
		setTitle( "影像类型预览" );
	}

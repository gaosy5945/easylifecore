<%@ page contentType="text/html; charset=GBK"%><%@
 ...
 <%
	...
	if( sObjectType.equals( "Customer" ) ){
		...
		String sCustomerType = Sqlca.getString( new SqlObject("Select CustomerType From Customer_Info "+
				" Where CustomerID = :CustomerID").setParameter( "CustomerID", sObjectNo ) );
		...
		sFilter = "%";
		/* sAppend += " and ECM_IMAGE_TYPE.TypeNo In (Select ImageTypeNo From ECM_PRDIMAGE_RELA Where ProductID = '"+ sBusinessType +"') "; */
		//sAppend += " and TypeNo In (Select ImageTypeNo From ECM_PRDIMAGE_RELA Where '900'  like ProductID||'%' ) ";
	}
...
<script type="text/javascript"> 
	...
	function TreeViewOnClick(){
		...
		if( sCurItemID != "null" && sCurItemID != "root" && hasChild(getCurTVItem().id) ){
			var param = "ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&TypeNo="+sCurItemID+"&ViewTypeNo=<%=sType%>";

									...
									<td height="1"> 
										<table id=table0 cols=3 border=0 cellpadding=0 cellspacing=0>
											<tr> 
												...
												<td nowrap><span class="groupboxcornerimg" style="display:inline-block;">&nbsp;</span></td>
											</tr>
										</table>
									</td>
								</tr>

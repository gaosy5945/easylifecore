...
/**
 * IdvLoanDtlQry个人贷款信息查询
 * 
 * @author T-wur
 * 
 */

public class IdvLoanInfoQryResponser implements IResponser {
	public void dispose(OCITransaction trans) throws Exception {
		...
		if(rs.next()){
			...
			data.put("IdvLoanInfoQry_O_svcbody"," ");
		...
		paraHashMap.put("ReturnMsg", "SOPE204接口调用出错。");

...
public class Process implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = process
	 * Namespace URI = http://impl.webservice.rdso.skyon.com/ Namespace Prefix =
	 * ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":process", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"process", xmlWriter);
						...
						if (!"process".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (Process) com.amarsoft.app.oci.ws.decision.ExtensionMapper

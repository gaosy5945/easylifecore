 ...
 * @version $Revision: 1.1 $ $Date: 2012/02/13 01:10:11 $
 * @version $Id: EmailSender.java,v 1.1 2012/02/13 01:10:11 jfeng Exp $
 */
public abstract class EmailSender
{
    ...
    /** */
    public static final String GBK = ARE.getProperty("CharSet","GBK");
    /** */
...
//                properties.setProperty(MAIL_SMTP_AUTH, "false");
     ...
     * @since 1.0
     */
    public EmailSender setFrom(String email)
        throws EmailException
    {
     ...
     * @since 1.0
     */
    public EmailSender setFrom(String email, String name)
        throws EmailException
    {
     ...
     * @since 1.1
     */
    public EmailSender setFrom(String email, String name, String charset)
        throws EmailException
    {
     ...
     * @since 1.1
     */
    public EmailSender addTo(String email, String name, String charset)
        throws EmailException
    {
     ...
     * @since 1.0
     */
    public EmailSender setTo(Collection aCollection) throws EmailException
    {
     ...
     * @since 1.1
     */
    public EmailSender addCc(String email, String name, String charset)
        throws EmailException
    {
     ...
     * @since 1.0
     */
    public EmailSender setCc(Collection aCollection) throws EmailException
    {
        if (aCollection == null || aCollection.isEmpty())
        {
            throw new EmailException("Address List provided was invalid");
     ...
     * @since 1.1
     */
    public EmailSender addBcc(String email, String name, String charset)
        throws EmailException
    {
     ...
     * @since 1.0
     */
    public EmailSender setBcc(Collection aCollection) throws EmailException
    {
        if (aCollection == null || aCollection.isEmpty())
        {
            throw new EmailException("Address List provided was invalid");
     ...
     * @since 1.0
     */
    public EmailSender addReplyTo(String email)
        throws EmailException
    {
     ...
     * @since 1.0
     */
    public EmailSender addReplyTo(String email, String name)
        throws EmailException
    {
     ...
     * @since 1.1
     */
    public EmailSender addReplyTo(String email, String name, String charset)
        throws EmailException
    {
     ...
     * @since 1.1
     */
    public EmailSender setReplyTo(Collection aCollection) throws EmailException
    {
        if (aCollection == null || aCollection.isEmpty())
        {
            throw new EmailException("Address List provided was invalid");
     ...
     * @since 1.0
     */
    public EmailSender setSubject(String aSubject)
    {
     ...
     * @since 1.0
     */
    public EmailSender setBounceAddress(String email)
    {
     ...
     * @since 1.0
     */
    public abstract EmailSender setMsg(String msg) throws EmailException;
    ...
    public void buildMimeMessage() throws EmailException
    {
        try
        {
            ...
            {
                this.message.setContent("", EmailSender.TEXT_PLAIN);
            }

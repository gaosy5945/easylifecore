 ...
 * @version $Id: MultiPartEmail.java,v 1.2 2012/02/13 01:10:11 jfeng Exp $
 */
public class MultiPartEmail extends EmailSender
{
     ...
     * @since 1.0
     */
    public EmailSender addPart(String partContent, String partContentType)
     ...
     *  @since 1.0
     */
    public EmailSender addPart(MimeMultipart multipart) throws EmailException
    {
        try
        {
     ...
     * @since 1.0
     */
    public EmailSender addPart(MimeMultipart multipart, int index) throws EmailException
    {
            BodyPart bodyPart = createBodyPart();
        try
        {
     ...
     * @since 1.0
     */
    public EmailSender setMsg(String msg) throws EmailException
    {

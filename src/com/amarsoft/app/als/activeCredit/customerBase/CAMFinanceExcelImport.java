...
public class CAMFinanceExcelImport extends AbstractExcelImport {
	...
	public boolean process(Map<String, DataElement> excelMap) {
		...
		try {
			...
			String AddCustomerFlagTemp = excelMap.get("ADDCUTOMERFLAG").getString();
			String AddCustomerFlag = CodeGenerater.getItemNoByName(AddCustomerFlagTemp,"YesNo");
			String FinanceAssetDailyOld = excelMap.get("FINANCEASSETDAILYOLD").getString();
			String FinanceAssetDaily = excelMap.get("FINANCEASSETDAILY").getString();
			String FinanceAssetDailyFixed = excelMap.get("FINANCEASSETDAILYFIXED").getString();
			String FinanceAssetDailyFloat = excelMap.get("FINANCEASSETDAILYFLOAT").getString();
			...
			boCAI.setAttributeValue("ADDCUTOMERFLAG", AddCustomerFlag);
			boCAI.setAttributeValue("FINANCEASSETDAILYOLD", FinanceAssetDailyOld);
			boCAI.setAttributeValue("FINANCEASSETDAILY", FinanceAssetDaily);
			boCAI.setAttributeValue("FINANCEASSETDAILYFIXED", FinanceAssetDailyFixed);
			boCAI.setAttributeValue("FINANCEASSETDAILYFLOAT", FinanceAssetDailyFloat);

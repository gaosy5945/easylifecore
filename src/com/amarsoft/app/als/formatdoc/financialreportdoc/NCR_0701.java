...
public class NCR_0701 extends FormatDocData implements Serializable {
	...
	public boolean initObjectForRead() {
		ARE.getLog().trace("NCR_0701.initObject()");
		...
		//	}
			...
			Double temp1;
			Double temp2;
			ReportSubject rs1 = null;
			ReportSubject rs2 = null;
...
//					extobj0.setAttr1(cfs.getReportDate());
					...
					if(reportMap.size()>0){
						...
						if(cfs.getFinanceBelong().equals(reportType)){
						rs = (ReportSubject) reportMap.get("137");//固定资产
						if(rs!=null){
							extobj18.setAttr1(rs.getCol2IntString());
						}
						}else{
							rs = (ReportSubject) reportMap.get("146");//固定资产
							if(rs!=null){
								extobj18.setAttr1(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs = (ReportSubject) reportMap.get("160");//商誉
							if(rs!=null){
								extobj26.setAttr1(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs = (ReportSubject) reportMap.get("158");//其他非流动资产
							if(rs!=null){
								extobj29.setAttr1(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs2 = (ReportSubject) reportMap.get("224");//流动负债合计
							rs1 = (ReportSubject) reportMap.get("246");
							if(rs1!=null&&rs2!=null){
								temp1=rs1.getCol1Value();
								temp2=rs2.getCol1Value();
								int temp;
								temp = (int)(temp1-temp2);
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj52.setAttr1(svalue.substring(0, length-3));							
							}
						}
...
//					extobj0.setAttr2(cfs1.getReportDate());
					...
					if(reportMap1.size()>0){
						...
						if(cfs1.getFinanceBelong().equals(reportType)){
						...
						rs = (ReportSubject) reportMap1.get("146");
						if(rs!=null){
							extobj18.setAttr2(rs.getCol2IntString());
						if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj18.getAttr1()!=null){
							d1 = (Double.parseDouble(extobj18.getAttr1().replace(",",""))-rs.getCol2Value())/rs.getCol2Value();
						...
						if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj26.getAttr1()!=null){
							...
							rs = (ReportSubject) reportMap1.get("160");
							if(rs!=null){
								extobj26.setAttr2(rs.getCol2IntString());
							if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj26.getAttr1()!=null){
								d1 = (Double.parseDouble(extobj26.getAttr1().replace(",",""))-rs.getCol2Value())/rs.getCol2Value();
						...
						if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj29.getAttr1()!=null){
							...
							rs = (ReportSubject) reportMap1.get("158");
							if(rs!=null){
								extobj29.setAttr2(rs.getCol2IntString());
							if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj29.getAttr1()!=null){
								d1 = (Double.parseDouble(extobj29.getAttr1().replace(",",""))-rs.getCol2Value())/rs.getCol2Value();
						...
						if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj30.getAttr1()!=null){
							...
							rs1 = (ReportSubject) reportMap1.get("165");//资产合计				 							
							rs2 = (ReportSubject) reportMap1.get("123");//流动资产合计															 							
							if(rs1!=null&&rs2!=null){
								temp1=rs1.getCol1Value();
								temp2=rs2.getCol1Value();
								int temp;
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj30.setAttr2(svalue.substring(0, length-3));							
							}
						...
						if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj52.getAttr1()!=null){
							...
							rs2 = (ReportSubject) reportMap1.get("224");//流动负债合计
							rs1 = (ReportSubject) reportMap1.get("246");
							if(rs1!=null&&rs2!=null){
								temp1=rs1.getCol1Value();
								temp2=rs2.getCol1Value();
								int temp;
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj52.setAttr2(svalue.substring(0, length-3));
						}
						}
...
//					extobj0.setAttr3(cfs2.getReportDate());
					...
					if(reportMap2.size()>0){
						...
						if(cfs2.getFinanceBelong().equals(reportType)){
						rs = (ReportSubject) reportMap2.get("137");
						if(rs!=null){
							extobj18.setAttr3(rs.getCol2IntString());
						}
						}else{
							rs = (ReportSubject) reportMap2.get("146");
							if(rs!=null){
								extobj18.setAttr3(rs.getCol2IntString());
						}
						}
						...
						if(rs!=null){
							...
							rs = (ReportSubject) reportMap2.get("160");
							if(rs!=null){
								extobj26.setAttr3(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs = (ReportSubject) reportMap2.get("158");
							if(rs!=null){
								extobj29.setAttr3(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs1 = (ReportSubject) reportMap2.get("165");//资产合计				 							
							rs2 = (ReportSubject) reportMap2.get("123");//流动资产合计															 							
							if(rs1!=null&&rs2!=null){
								temp1=rs1.getCol1Value();
								temp2=rs2.getCol1Value();
								int temp;
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj30.setAttr3(svalue.substring(0, length-3));							
							}
						}
						...
						if(rs!=null){
							...
							rs2 = (ReportSubject) reportMap2.get("224");//流动负债合计
							rs1 = (ReportSubject) reportMap2.get("246");
							if(rs1!=null&&rs2!=null){
								temp1=rs1.getCol1Value();
								temp2=rs2.getCol1Value();
								int temp;
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj52.setAttr3(svalue.substring(0, length-3));
						}
						}
...
//					extobj0.setAttr4(cfs3.getReportDate());
					...
					if(reportMap3.size()>0){
						...
						if(cfs3.getFinanceBelong().equals(reportType)){
						rs = (ReportSubject) reportMap3.get("137");
						if(rs!=null){
							extobj18.setAttr4(rs.getCol2IntString());
						}
						}else{
							rs = (ReportSubject) reportMap3.get("146");
							if(rs!=null){
								extobj18.setAttr4(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs = (ReportSubject) reportMap3.get("160");
							if(rs!=null){
								extobj26.setAttr4(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs = (ReportSubject) reportMap3.get("158");
							if(rs!=null){
								extobj29.setAttr4(rs.getCol2IntString());
							}
						}
						...
						if(rs!=null){
							...
							rs1 = (ReportSubject) reportMap3.get("165");//资产合计				 							
							rs2 = (ReportSubject) reportMap3.get("123");//流动资产合计															 							
							if(rs1!=null&&rs2!=null){
								temp1=rs1.getCol1Value();
								temp2=rs2.getCol1Value();
								int temp;
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj30.setAttr4(svalue.substring(0, length-3));							
							}
						}
						...
						if(rs!=null){
							...
							rs2 = (ReportSubject) reportMap3.get("224");//流动负债合计
							rs1 = (ReportSubject) reportMap3.get("246");
							if(rs1!=null&&rs2!=null){
								temp1=rs1.getCol1Value();
								temp2=rs2.getCol1Value();
								int temp;
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj52.setAttr4(svalue.substring(0, length-3));							
							}
						}
...
//					extobj0.setAttr5(cfs4.getReportDate());
					...
					if(reportMap3.size()>0){
						...
						if(cfs4.getFinanceBelong().equals(reportType)){
						rs = (ReportSubject) reportMap3.get("137");
						if(rs!=null){
						...
						if(rs!=null){
							...
							if(rs1!=null && rs2!=null){
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj30.setAttr5(svalue.substring(0, length-3));							
							}
						}
						...
						if(rs!=null){
							...
							if(rs1!=null&&rs2!=null){
								...
								String svalue = DataConvert.toMoney(temp);
								int length = svalue.length();
							extobj52.setAttr5(svalue.substring(0, length-3));	
						}
						}
						rs = (ReportSubject) reportMap3.get("246");
						if(rs!=null){

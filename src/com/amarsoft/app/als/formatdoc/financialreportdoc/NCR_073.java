 ...
 *
 */
public class NCR_073 extends FormatDocData implements Serializable{
	...
	public boolean initObjectForRead() {
		ARE.getLog().trace("NCR_073.initObject()");
...
//			}
			...
			if(sCustomerID!=null&& !"".equals(sCustomerID)){
				...
				CustomerFSRecord cfs = financedata.getNewYearReport(sCustomerID);//最近年报
				if(cfs != null){
		...
		// }
					...
					if(cfs2 != null ){
//						extobj0.setAttr2(cfs2.getReportDate());
						...
						if(reportMap.size()>0){
							...
							if(rs!=null){
								...
								if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj32.getAttr1()!=null){
									...
									extobj32.setAttr4(String.format("%.0f",d1*100));
								}else {
									extobj32.setAttr4("");
								}
							}
							...
							if(rs!=null){
								...
								if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj33.getAttr1()!=null){
									...
									extobj33.setAttr4(String.format("%.0f",d1*100));
								}else {
									extobj33.setAttr4("");
								}
							}
							...
							if(rs!=null){
								...
								if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj34.getAttr1()!=null){
									...
									extobj34.setAttr4(String.format("%.0f",d1*100));
								}else {
									extobj34.setAttr4("");
								}
							}
							...
							if(rs!=null){
								...
								if(String.valueOf(rs.getCol2Value())!=null && rs.getCol2Value()!=0 && extobj35.getAttr1()!=null){
									...
									extobj35.setAttr4(String.format("%.0f",d1*100));
								}else {
									extobj35.setAttr4("");
								}
							}

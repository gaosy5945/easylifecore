...
public class EquipmentInfoHandler extends CommonHandler {
	...
	protected void afterInsert(JBOTransaction tx, BizObject bo)
		...
		new PartnerProjectInfo(serialno).
			initProjectRelative(tx, CustomerConst.PARTNER_RELATIVE_TYPE_8, bo.getAttribute("SerialNo").getString(), "");
	}

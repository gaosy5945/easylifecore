...
public class WarterCraftListHandler extends CommonHandler {
	protected void afterDelete(JBOTransaction tx, BizObject bo)
		...
		new PartnerProjectInfo(serialno).
			replaceProjectRelative(tx, CustomerConst.PARTNER_RELATIVE_TYPE_7, bo.getAttribute("SerialNo").getString());
	}

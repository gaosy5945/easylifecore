 ...
 public Object  run(Transaction Sqlca) throws Exception
	 {
	    ...
	    if(rs.next())
	    {
	    	sCasePhase = rs.getString("CasePhase"); //案件阶段 010	
	    	sCaseStatus = rs.getString("CaseStatus");//案件当前进程 空
	    	sCourtStatus = rs.getString("CourtStatus");//当前受理法院  空
	    	sCognizanceResult = rs.getString("CognizanceResult");//受理结果  空
	    }

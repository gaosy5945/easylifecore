...
public class AddVehicleInfoHandler extends CommonHandler{

	/**
	 * @gftang 2013-11-21
	 * 
	 * 业务申请插入汽车用途信息同时插入关联信息
	 */
	public  void afterInsert(JBOTransaction tx, BizObject bo) throws Exception{
		try{
			...
			BizObjectManager bm=JBOFactory.getBizObjectManager("jbo.app.VEHICLE_RELATIVE");
			tx.join(bm);
